      ...
      <main className="relative w-full max-w-md min-h-screen bg-[var(--bg-shell)] border-x border-[var(--border-color)] pb-24 overflow-x-hidden shadow-2xl transition-colors duration-300">
        ...
        <section className="relative z-10 px-5 pt-6 pb-4 text-center">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <button className="w-full flex items-center justify-center gap-2 bg-neutral-800/80 active:bg-neutral-700 border border-[var(--border-color)] text-[var(--text-primary)] font-bold uppercase text-xs tracking-wider py-3.5 rounded-xl transition-all">
              Collaborators
            </button>
          </div>
        </section>
